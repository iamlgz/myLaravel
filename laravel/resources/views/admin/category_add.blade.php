...
<div class="box box-info">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form class="form-horizontal" method="post" action="{{url('admin/category/add')}}" onsubmit="return verify()" enctype="multipart/form-data">
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    @foreach($attr as $v)
                    <input type="checkbox" name="attrid[]" value="{{$v['id']}}">{{$v['name']}}&nbsp;&nbsp;
                    @endforeach
                </div>
            </div>
